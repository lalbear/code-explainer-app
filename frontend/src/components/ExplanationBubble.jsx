    ...
    <div className="rounded-xl border border-slate-300 dark:border-slate-700 bg-slate-50 dark:bg-slate-900 p-6 space-y-4 shadow-sm transition">
      ...
      <div className="flex justify-end gap-3">
        ...
        <button
          ...
          className="flex items-center gap-1.5 text-sm px-4 py-2 rounded-lg font-medium text-white bg-red-500 hover:bg-red-600 dark:bg-red-600 dark:hover:bg-red-500 transition-all duration-200"
        >
